...
const infos = [
  {
    icon: <PhoneIcon />,
    description: "+44 20 3920 7456"
  },
  {
    icon: <MailIcon />,
    description: "shopping@wearepolymer.com"
  }
];
...
export default withWidth()(withStyles(styles, { withTheme: true })(WeFooter));
